                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user @error('no_handphone') is-invalid @enderror" id="phone" name="no_handphone" value="{{old('no_handphone')}}" required
