                                    ...
                                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between bg-white">
                                        <div class="dropdown no-arrow">
                                            ...
                                            <h5 style="margin-left: 60px; color:#000; margin-top: -45px; font-size: 15px;">
                                                Mark Roll</h5>
                                            <p style="margin-left: 60px; font-size: 12px;">1d ago</p>
                                        </div>
                                    </div>
                                    <!-- Card Body -->
                                    <div class="card-body">
                                        <h5 style="color: #435AE7;">Question</h5>
                                        <p style="color:#000; font-size: 15px;">What is the first step in planning to create a website?</p>
                                        ...
                                        <p style="color: #000; margin-left: 20px; font-size: 15px; margin-top: 25px;">Define the objective, identify the audience, choose the domain name, 
